...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func presentMainUI() {
        ...
        // Do extra set up for those who already have the app installed but don't have these features
        let extra = ExtraSetUp()
        extra.setUp()
    }
...
//        */
//        let container = NSPersistentContainer(name: "mo_ikai")
