        ...
        Background {
            VStack {
                ...
                VStack(alignment: .leading, spacing: 20) {
                    ...
                    Text("If you add AI notifications to a habit, the name of that habit will be used when querying OpenAI to generate unique notifications. However, there is no personal information which can be tied back to you associated with these requests, and I can't see the body of these requests on OpenAI's website.")
